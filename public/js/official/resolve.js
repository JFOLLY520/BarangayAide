...
firebase.auth().onAuthStateChanged(firebaseUser=> {
    ...
    .then(function(querySnapshot) {
        querySnapshot.forEach(function(doc) {
            ...
            db.collection("posts").where("accepted","==",true).where("status","==","Ongoing").where("barangayID","==",barangayID).orderBy("datetime","desc")
                .get()
                .then(function(querySnapshot) {
                    querySnapshot.forEach(function(doc) {
...
bootbox.confirm({
  ...
  var docRef = db.collection("users").doc(uidGet); //takes uid of current user
    docRef.get().then(function(doc) {
      ...
      if (newest.checked) {
        db.collection("posts").where("accepted","==",true).where("status","==","Ongoing").where("barangayID","==",brgyID).orderBy("datetime","desc")
